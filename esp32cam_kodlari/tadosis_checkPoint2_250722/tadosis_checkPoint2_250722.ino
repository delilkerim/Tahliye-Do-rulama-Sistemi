...
#define USER_EMAIL "checkpoint2@mail.com"
...
// ÖĞRENCİ CHECKPOINT-2'E ULAŞTIĞI ZAMAN BU DEĞİŞKENE 1,SİSTEM İLK ÇALIŞTIRILDIĞINDA İSE 0 BİLGİSİ YÜKLENMEKTEDİR.
int x = 0;
...
void setup() {
  ...
  pinMode(13, INPUT);
  Firebase.RTDB.setInt(&fbdo, "CheckPoint-2", x);
...
void loop() {
  // EĞER CHECKPOINT-2 MICROBIT'INDEN 1 BİLGİSİ GELDİYSE FIREBASE DURUMU 1 OLARAK KAYDEDİLECEKTİR.
  if (digitalRead(13) == HIGH)
  {
    while (digitalRead(13) == HIGH);    
    x = 1;    
    if (Firebase.ready()) {         
        // checkPoint-2 noktasının 1 olması gerekir
        Firebase.RTDB.setInt(&fbdo, "CheckPoint-2", x);        
